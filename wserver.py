    ...
    <header>
      <div class="brand">
        ...
        <a href="https://t.me/missemily2022">
          <h2 class="name">Qbittorrent Selection (Emily RSS Mirror Bot)</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/missemily2022/RSSMirrorBot"><i class="fab fa-github"></i></a>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See Emily Mirror RSS Bot  <a href='https://github.com/missemily2022/RSSMirrorBot'>at GitHub</a> By <a href='https://github.com/missemily2022'>Miss Emily</a></h1>", content_type="text/html")
